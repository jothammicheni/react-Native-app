      ...
      <KeyboardAvoidingView>
        <View>
         ...
         >
            ...
            <Text style={{ textAlign:'center',fontSize:16,fontWeight:'bold',color:'#ffff'}}>Register</Text>
         </Pressable>
         ...
         >
            <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'grey'}}>Have an account? Login</Text>
         </Pressable>
        </KeyboardAvoidingView>
